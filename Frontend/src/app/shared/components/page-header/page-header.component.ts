...
export class PageHeaderComponent implements OnInit, OnDestroy {
  ...
  title: string = '';
  subtitle: string = '';
  private readonly SOURCE = "page-header.component.ts";
  ...
  private setupSocketListeners(): void {
    this.subscriptions.push(
      this.socketService.getNotifications().subscribe(() => {
        this.loggingService.log(this.SOURCE, 'in the page header component the notification is received');
        this.refreshNotifications();
      })
    );
  }
  ...
  private refreshNotifications(): void {
    ...
    this.subscriptions.push(
      ...
      this.notificationService.getUnreadCountObservable().subscribe(count => {
        this.loggingService.log(this.SOURCE, 'in the page header component the unread count is received', count);
